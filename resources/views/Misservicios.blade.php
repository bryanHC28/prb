...
<br>
<br>
<a class="btn btn-primary btn-lg" href="{!! asset('servicios/create')!!}">CREAR NUEVO SERVICIO</a>
...
<td>
    ...
    <a class="btn btn-primary btn-lg" href="{!!'servicios/'.$servicio->id.'/edit'!!}">Editar</a>
